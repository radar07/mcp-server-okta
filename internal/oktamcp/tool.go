...
type PropertyOption func(schema map[string]any)
...
func DefaultValue(value any) PropertyOption {
	return func(schema map[string]any) {
...
func addNumberPropertyOptions(
	...
	schema map[string]any) []mcp.PropertyOption {
...
func addDefaultValueOptions(
	propOpts []mcp.PropertyOption,
	defaultValue any) []mcp.PropertyOption {
...
func addEnumOptions(
	propOpts []mcp.PropertyOption,
	enumValues any) []mcp.PropertyOption {
...
func NewToolResultJSON(data any) (*ToolResult, error) {
